...
void StakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("worldgreencoin-stakeminer");
...
{
    printf("WorldGreenCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    ...
    try { loop {
        ...
        {
            printf("WorldGreenCoinMiner : no more PoW blocks\n");
            return;
        }

        IncrementExtraNonce(pblock, pindexPrev, nExtraNonce);

        printf("Running WorldGreenCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("WorldGreenCoinMiner terminated\n");
        throw;
    }
}

void GenerateWorldGreenCoins(bool fGenerate, CWallet* pwallet)
{
