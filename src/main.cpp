...
uint256 hashGenesisBlock("0x8f207423277fc7a6f903f830dd569da71e72c0198e348b6a4656fc7ee608edc3");
uint256 hashGenesisBlockTestNet("0x7ed760b11a149b1a8eb715013919ef9e589649852ae2a30619aeb6ab07df4c6f");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WorldGreenCoin: starting difficulty is 1 / 2^12
...
{
    // WorldGreenCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
const int64 nTargetSpacing = 60; // WorldGreenCoin: 1 minute block
static const int64 nTargetTimespan = 60 * 60; // WorldGreenCoin: Not used
...
{
    // WorldGreenCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime = 1524700800;
        block.nBits = 0x1e0ffff0;
        block.nNonce = 1160068;

        if (fTestNet)
        {
            txNew.nTime = block.nTime = 1524704400;
            block.nNonce = 1112081;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x57548660eaf6802232f9ef914689a792b7a013bacf67b75401471cb5c34bd72e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // WorldGreenCoin: increase each by adding 2 to bitcoin's value.
